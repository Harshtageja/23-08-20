...
<input  class="v" type="date" name="dob" placeholder="D.O.B" style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left: 0px;height: 40px;border-radius: 15px;padding-left: 10px;"><br><br>
<input  class="d" type="number" name="number" placeholder="Your Contact No." style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left: 0px;height: 40px;border-radius: 15px;padding-left: 10px;"><br><br>
<?php
