...
<body>
 ...
 <div style="width: 300px;border:2px solid black;position: relative;left: 60%;padding-bottom: 5px;">
    <?php
  $conn= new mysqli("localhost","root","","truck");
  $sql="select chat,Sender,receiver from message where sender='".$_POST['Email']."' && receiver='".$_POST['id']."'";
  $res=$conn->query($sql);
  if($res->num_rows>0){
...
?>
 <br><br><br><br>
  ...
  ?>
   <input type="text" name="msg" style="width: 60%" placeholder="Message..."><button type="button" class="btn btn-dark" style="margin-left:10px;height: 25px;font-size: 10px">Send</button>
 </div>
