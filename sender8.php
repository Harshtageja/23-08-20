...
<form action="http://localhost/sender9.php" method="post" enctype="multipart/form-data" name="image">
    ...
    <input class="v" type="int" name="pickup"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder=" #455 dash colony,Mumbai"><br><br>
        <label style="font-weight: bolder;margin-left: -5rem">To</label>
    <input class="v" type="int" name="dest"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder=" #455 dash colony,Mumbai"><br><br>
