...
<body> <nav class="navbar navbar-expand-lg navbar-dark  fixed-top" style="background-color: black;color: black;">
  <a class="navbar-brand" href="pr2-3.php" style="background-color: black;font-size: 25px;">BB Trucks</a>
...
<select id="cars" name="gender" style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;">
  <option value="male">Male</option>
  <option style=" text-align:center;" value="Female">Female</option>
</select><br><br><br><br>
<input  class="v" type="Password" name="Password" placeholder="Your Password" style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left: 8rem;height: 40px;border-radius: 15px;padding-left: 10px;"> <input id="z" onclick="check()" type="checkbox"><label>Show Password</label> <br><br>
<?php
