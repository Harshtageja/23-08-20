...
<form method="post" action="changeprice1.php"><input type="text" name="id" value="<?php echo $row['id'] ?>" style="display: none;width: 0px;height: 0px;margin: 0px 0px;" >
 <button href="#" type="submit" class="btn btn-dark" style="background-color: black;border-radius:10px">Change Price</button> </form><br><button href="#" type="submit" class="btn btn-dark" style="background-color: black;border-radius:10px;margin-left: ">Queries</button><br><br><form action="requests.php" method="post">
