...
<input  class="v" type="password" name="password" placeholder="Your Password...." style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;height: 40px;border-radius: 15px;padding-left: 10px;"><br><br><br><input id="z" type="checkbox" onclick="check()"><label>Show Password</label><br><br>
<?php
